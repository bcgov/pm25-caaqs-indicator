---
title: "Status of Fine Particulate Matter in B.C. (2020-2022)"
topic: air
header-includes:
...
-   **Fine particulate matter levels met both of the Canadian Ambient
    ...
    Northeast, Georgia Strait, and Lower Fraser Valley air zones met both the PM~2.5~ annual and 24-hour standards. The Central Interior air zone exceeded the PM~2.5~ 24-hour standard at Houston and Valemount, and the PM~2.5~ annual standard at Vanderhoof. The Southern Interior air zone exceeded the PM~2.5~ annual standard at Grand Forks.
...
*Suggested Citation*:  
Environmental Reporting BC. `r format(Sys.Date(), "%Y")`. Status of Fine Particulate Matter in B.C. (`r year_range`). State of Environment Reporting, Ministry of Environment and Climate Change Strategy, British Columbia, Canada.
