...
*Suggested Citation*:  
Environmental Reporting BC. `r format(Sys.Date(), "%Y")`. Status of Fine Particulate Matter in B.C. (`r year_range`). State of Environment Reporting, Ministry of Environment and Parks, British Columbia, Canada.
