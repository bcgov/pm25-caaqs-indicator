...
-   **Fine particulate matter levels met the Canadian Ambient Air
    ...
    B.C.** There are two standards for PM~2.5~ - an annual standard and a
...
-   **Two of B.C.'s seven air zones met the Canadian Ambient Air Quality
    ...
    estimate the PM~2.5~ metrics for the Northeast air zone for this reporting
...
-   There are two standards for fine particulate matter (PM~2.5~): the
    24-hour standard, which is the 3-year average of the annual 98th
    percentile of the daily average concentrations of PM~2.5~, and the
...
-   The Air Zone Management Framework defines air zone management levels
    ...
    Air zone management levels for PM~2.5~ are based on the higher of the
    PM~2.5~ annual and the PM~2.5~ 24-hour management levels.
