...
-   Note that while the Kitimat Haisla Village station in the Coastal air zone 
    had an annual level that would indicate an 'orange' management level, it was 
    excluded from consideration because the level was based on only two years of 
    data, with three year reporting stations available in the air zone.
