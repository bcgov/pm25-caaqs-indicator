  ...
  \fbox{
    \begin{minipage}[c]{12cm}
      ...
      \begin{itemize}
        ...
        \item
          The \textbf{PM$_{\text{2.5}}$ 24-hour metric} should be lower than \textbf{28 micrograms per cubic metre (µg/m3)}.
        \item
          The \textbf{PM$_{\text{2.5}}$ annual metric} should be lower than \textbf{10.0 micrograms per cubic metre (µg/m3)}.
      \end{itemize}
...
-   **Two of B.C.'s seven air zones met the Canadian Ambient Air Quality
    ...
    estimate the PM$_{\text{2.5}}$ metrics for the Northeast air zone for this reporting
...
well as both the annual and 24-hour CAAQS PM$_{\text{2.5}}$ metric values at individual
...
-   There are two standards for fine particulate matter (PM$_{\text{2.5}}$): the
    24-hour standard, which is the 3-year average of the annual 98th
    percentile of the daily average concentrations of PM$_{\text{2.5}}$, and the
    annual standard, which is the 3-year average of the annual average
    concentration of PM$_{\text{2.5}}$.
...
-   The Air Zone Management Framework defines air zone management levels
    ...
    Air zone management levels for PM$_{\text{2.5}}$ are based on the higher of the
    PM$_{\text{2.5}}$ annual and the PM$_{\text{2.5}}$ 24-hour management levels.
...
-   The Central Interior and Georgia Strait air zones were assigned to a 
    ...
    orange management level. Note that while two stations in the Coastal air zone (Kitimat Haisla 
    ...
    data. There was not enough data to estimate the management level for the Northeast air zone for this reporting period, and currently there are no [air monitoring stations](http://www2.gov.bc.ca/gov/content?id=292EC5BD62A149A192B7DD2CE155E33E) in the Northwest air zone. Please see the box below for information on how influences from 
...
-   Wildfires are generally the largest contributor to
    ...
    exceeded the standard of 28 µg/m^3^. Those daily concentrations were
