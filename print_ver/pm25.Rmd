...
\begin{center}
  \fbox{
    \begin{minipage}[c]{12cm}
      \centering{\textbf Fine Particulate Matter (PM$_{\text{2.5}}$):\\ Canadian Ambient Air Quality Standard}
...
-   **Two of B.C.'s seven air zones met the Canadian Ambient Air Quality
    ...
    estimate the PM2.5 metrics for the Northeast air zone for this reporting
...
-   The PM2.5 metric for an air zone is the highest PM2.5 metric value
    reported from monitoring stations within the air zone. Air zone metric values are only taken from stations reporting on two years of data when there are no available three year reporting stations in the air zone.
...
-   Before determining management levels, jurisdictions have the option
    ...
    control.
-   Wildfires are generally the largest contributor to
    transboundary flows and exceptional events in B.C. Over the 2014-16
    reporting period, 50 stations had one or more days during the wildfire
...
(PDF)](http://www.ccme.ca/files/Resources/air/aqms/pn_1483_gdad_eng.pdf)
published by the [Canadian Council of Ministers of the Environment](http://www.ccme.ca/index.html).
