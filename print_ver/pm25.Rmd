...
params:
  min_year: 2015
  max_year: 2017
title: "Status of Fine Particulate Matter in B.C. (2015-2017)"
---
<!--
...
-   **Fine particulate matter levels met the Canadian Ambient Air
    ...
    for PM$_{\text{2.5}}$---an annual standard and a
...
-   **Fine particulate matter levels met both of the Canadian Ambient
    ...
    Northeast, and Georgia Strait air zones met the PM$_{\text{2.5}}$ annual
    standard, while the Central Interior and Southern Interior air zones 
    exceeded it. The Coastal and Northeast air zones met the PM$_{\text{2.5}}$ 
    24-hour standard, while the Central Interior Southern Interior, and Georgia
    Strait air zones exceeded it. 
    Many of the exceedances were due to the influence of smoke from wildfires, 
    especially during the summer of 2017. 
-   There was not enough data to estimate PM$_{\text{2.5}}$ levels for the
    Northeast air zone for this reporting period. Currently, there are no 
...
# Status of 24-hour PM$_{\text{2.5}}$ Levels in B.C. Air Zones (`r year_range`)
...
# Status of Annual PM$_{\text{2.5}}$ Levels in B.C. Air Zones (`r year_range`)
...
# PM$_{\text{2.5}}$ Metrics for Air Monitoring Statons within B.C. Air Zones (`r year_range`)

```{r ambient_summary_plot}
# run the @knitr ambient_summary_plot chunk in ../04_output.R
```
```{r, fig.height=9}
...
-   The Central Interior and Georgia Strait air zones were assigned to a
    red management level, the Lower Fraser Valley, Coastal, and Northeast air zones
    were assigned to a yellow management level, and the Southern
    Interior to an orange management level. There are currently no 
    [air monitoring stations](http://www2.gov.bc.ca/gov/content?id=292EC5BD62A149A192B7DD2CE155E33E)
    in the Northwest air zone.
...
```{r mgmt_map}
# run the @knitr mgmt_map chunk in ../04_output.R
```
