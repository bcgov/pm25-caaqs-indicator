...
m %>%
  ...
  addLegend("bottomright", group = "Annual",
            ...
            colors = filter(labels_ambient, metric_short == "annual") %>%
              pull(colour), 
            labels = filter(labels_ambient, metric_short == "annual") %>%
              pull(labels_full),
            opacity = 1, 
...
m %>%
  ...
  addLegend("bottomright", group = "24h",
            ...
            colors = filter(labels_ambient, metric_short == "24h") %>%
              pull(colour), 
            labels = filter(labels_ambient, metric_short == "24h") %>%
              pull(labels_full),
            opacity = 1, 
