...
leaflet(width = "900px", height = "700px", options = leafletOptions(minZoom = 5)) %>% 
  ...
  addPolygons(data = az_annual,
              ...
              highlightOptions = highlightOptions(bringToFront = TRUE, 
                                                  fillOpacity = 0.7)) %>%
  addMarkers(data = stations_annual,
  ...
  addLegend("bottomleft", colors = rev(station_annual_colours),
  ...
  addLegend("bottomright", colors = pal_az_annual(names(az_annual_colours)), 
            labels = names(az_annual_colours), 
            opacity = 1, 
